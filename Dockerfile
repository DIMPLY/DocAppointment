...
RUN apt-get update && apt-get install -y curl dnsutils wget python-software-properties software-properties-common python3-pip python3-dev && pip3 install --upgrade pip && su - && apt-get install sudo -y
